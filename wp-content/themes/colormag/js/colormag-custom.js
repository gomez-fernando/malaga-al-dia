jQuery(document).ready(function () {
  ...
  jQuery(
    ".better-responsive-menu #site-navigation .menu-item-has-children"
  ).append(
    '<span class="sub-toggle"> <i class="fa fa-caret-down"></i> </span>'
  );
  ...
  jQuery(window).load(function () {
    if (
      ...
      jQuery("#masthead .sticky-wrapper").length >= 1
    ) {
