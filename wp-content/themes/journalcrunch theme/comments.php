...
<?php if ( have_comments() ) : ?>
	<h2 class="h2comments"><?php comments_number(__("No Comments", "site5framework"),__("1 Comment", "site5framework"),__("% Comments", "site5framework") );?> <a href="#respond" class="addComment"><?php _e("+ Add Comment", "site5framework"); ?></a></h2>
...
<h2 id="commentsForm"><?php comment_form_title( __("Got anything to say? Go ahead and leave a comment!", "site5framework"), __("Leave a comment to %s", "site5framework")); ?></h2>
...
<p><label for="author"><?php _e("Name", "site5framework"); ?> <?php if ($req) _e("(required)", "site5framework"); ?></label>
<input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
</p>

<p><label for="email"><?php _e("Mail (will not be published)", "site5framework"); ?> <?php if ($req) _e("(required)", "site5framework"); ?></label>
...
<p><small><strong>XHTML:</strong> <?php _e("You can use these tags", "site5framework"); ?>: <code><?php echo allowed_tags(); ?></code></small></p>
