...
require (OPTIONS_FRAMEWORK_DIRECTORY . 'inc/sliderpost.metabox.php');
...
function optionsframework_options() {
	...
	$blogpath =  get_stylesheet_directory_uri() . '/images/';
