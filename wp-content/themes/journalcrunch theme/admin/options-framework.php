...
function optionsframework_page() {
	...
	$themename = get_theme_data(get_stylesheet_directory_uri() . '/style.css');
	  ...
	  <?php settings_fields('optionsframework'); ?>
        ...
        <div id="header">
          ...
          <div class="site5author">
            <h2><a href="http://www.site5.com/wordpress-themes/"><?php esc_attr_e( 'A Theme by','site5framework' ); ?> <strong><?php esc_attr_e( 'Site5.com','site5framework' ); ?></strong></a></h2>
          </div>
