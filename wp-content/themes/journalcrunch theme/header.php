		...
		<header>
			...
			<!-- Begin #logo -->
			 ...
			 <div id="logo"><a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
                ...
                <span>Las noticias de Málaga y su región</span>
			...
			<div id="topSocial">
				...
				<ul>
					...
					<li><a href="<?php bloginfo('rss2_url'); ?>" title="<?php _e("Subcribe to Our RSS Feed", "site5framework"); ?>" class="rss"><img src="<?php bloginfo('template_directory'); ?>/images/spacer.gif" alt="<?php _e("Subcribe to Our RSS Feed", "site5framework"); ?>" /></a></li>
